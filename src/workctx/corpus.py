...
2. Prefer primary source documents over summaries
3. Consider timestamps — more recent content may supersede older content
4. Distinguish between decisions, proposals, drafts, and completed work
5. Identify conflicting information across sources
...
- `jira/` — issues with comments (one per file)
